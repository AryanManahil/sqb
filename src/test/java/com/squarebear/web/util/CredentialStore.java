...
public class CredentialStore {
    ...
    public boolean has(String key) {return credentials.containsKey(key);}
    public String get(String key) {return credentials.get(key);}

    public void put(String key, String value) {credentials.put(key,value);}

    private boolean isPopulated() {return populated;}

    public boolean isNotPopulated() {return !isPopulated();}
